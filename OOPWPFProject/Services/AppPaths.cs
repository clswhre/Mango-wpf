...
public static class AppPaths
{
    ...
    static AppPaths()
    {
        ...
        _appDataDir = Path.Combine(Path.Combine(root, AppFolderName));
        _logsDir = Path.Combine(Path.Combine(_appDataDir, LogsFolderName));
    }
    ...
    public static string CoolSaveFilePath => Path.Combine(AppDataDir, SaveFileName);
