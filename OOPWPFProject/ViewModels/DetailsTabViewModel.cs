...
internal class DetailsTabViewModel : BaseViewModel
{
    ...
    public Visibility IsEditHistoricalVisible => _selectedPlace is HistoricalPlace ? Visibility.Visible : Visibility.Collapsed;
    public Visibility IsEditNaturalVisible => _selectedPlace is NaturalPlace ? Visibility.Visible : Visibility.Collapsed;
    ...
    private bool CanSaveEdit() => _selectedPlace != null &&
